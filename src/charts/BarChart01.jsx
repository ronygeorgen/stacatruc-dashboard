    ...
    const newChart = new Chart(ctx, {
      ...
      options: {
        ...
        onClick: (event, elements, chart) => {
          const elementsAtEvent = chart.getElementsAtEventForMode(event, 'nearest', { intersect: true }, true);
          if (elementsAtEvent.length > 0) {
            const { datasetIndex, index } = elementsAtEvent[0];
            onBarClick?.({ datasetIndex, index });
          }
        },
        scales: {
